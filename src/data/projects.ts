...
export const projects: Project[] = [
    ...
    role: 'Projet de 1ère année MMI - Concept d\'application mobile',
    tools: ['Figma'],
...

  {
    ...
    role: 'Projet de 1ère année MMI - Création one page pour le lancement d\'un produit premium',
    tools: ['Figma'],
...

  {
    ...
    tools: ['Figma', 'WordPress'],
    description: 'Refaire son site web en intégrant une partie pour les professionnels, pour qu\'ils puissent passer commande pour leurs évènements',
...

  {
    ...
    role: 'Refonte du site web d\'une marque de sauces piquantes',
    tools: ['Figma'],
