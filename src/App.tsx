...
export default function App() {
      ...
      return (
        <div>
          ...
          <div className="flex flex-wrap items-center gap-2 mb-8">
            ...
            >
              <img src="./assets/logo.svg" alt="Profile" className="w-8 h-8 rounded-full object-cover" loading="lazy" />
            </button>
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <main
        className={`ml-0 md:ml-64 p-4 md:p-8 overflow-x-hidden md:pb-32 ${currentProject ? 'pb-player-open' : 'pb-24'}`}
      >
        {renderContent()}
      </main>
